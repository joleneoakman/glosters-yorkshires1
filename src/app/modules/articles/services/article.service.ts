...
export class ArticleService {
  ...
  constructor() {
    this.articles.push({
      id: 'about-us',
      title: 'Peeters<br>Glosters & Yorkshires',
      icon: null,
      snippetText: '',
      fullText: `
        <h2>Hallo, en welkom op onze website!</h2>
    ...
    this.articles.push({
      ...
      icon: null,
      snippetText: `
        In 1980 kocht ik mijn eerste glosterkanaries. Met veel passie kweekte ik mijn eerste glosters en na enkele jaren nam ik
    ...
    this.articles.push({
      ...
      icon: null,
      snippetText: `
        De gloster is en blijft onze favoriete postuurkanarie, maar ook de yorkshire kanarie, de "gentelman van de
...
`
    ...
    this.articles.push({
      ...
      fullText: `
      <p>Heb je vragen? Aarzel dan niet om ons te contacteren!</p>
